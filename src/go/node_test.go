...
func TestForNode(t *testing.T) {
	...
	assert.Equal(
		t,
		"\t\t<p>isfirst?true</p>\t\t<p>johnny</p>\t\t<p>jbone@gmail.com</p>\t\t\t<p>isfirst?false</p>\t\t<p>cameron</p>\t\t<p>boner@gmail.com</p>\t",
		strippedResult)
}

// func TestKeyValueForNode(t *testing.T) {
// 	var testContext = `{"people_stats": {"cam": "awesome", "bob": "meh", "buddy": "wow!"}}`
// 	var testSource = `
// 	{% for name, stat in people_stats.items %}
// 		<p>{{ name }} {{ stat }}</p>
// 	 {% endfor %}`
